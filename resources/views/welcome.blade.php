                    ...
                    <div class="me-5 lg:me-0 lg:hidden flex items-center">
                        ...
                        <div class="lg:hidden ms-1">
                            ...
                            <div class="hs-dropdown  relative  [--auto-close:inside] inline-flex">
                                ...
                                <!-- Dropdown -->
                                <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-full md:w-[450px] transition-[opacity,margin] duration opacity-0 hidden z-30 overflow-hidden border border-gray-200 bg-white rounded-xl shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:bg-neutral-800 dark:border-neutral-700"
                                    ...
                                    <div
                                        ...
                                        <nav class="flex  gap-x-1" aria-label="Tabs" role="tablist"
                                            ...
                                            <button type="button"
                                                ...
                                                id="hs-pmn-item-free" aria-selected="true" data-hs-tab="#hs-pmn-free"
                                                aria-controls="hs-pmn-free" role="tab">
                                                Free
                                            </button>
                                        </nav>
                                        <!-- End Nav Tab -->
                                    ...
                                    <div id="hs-pmn-pro" class="hidden" role="tabpanel" aria-labelledby="hs-pmn-item-pro">
                                        ...
                                        <div class="p-3 flex flex-wrap justify-between items-center gap-3">
                                            <span
                                                class="block font-semibold text-sm text-gray-800 dark:text-neutral-200">Templates
                                                (12)</span>

                                            <div class="ms-auto">
                                                <a class="group py-2 px-2.5 rounded-md flex items-center gap-x-1 text-[13px] bg-gray-800 text-white hover:bg-gray-900 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-900 dark:bg-white dark:hover:bg-neutral-200 dark:focus:bg-neutral-200 dark:text-neutral-800"
                                                    href="../../pro/pricing.html">
                                                    Purchase
                                                    <svg class="hidden md:inline-block shrink-0 size-3.5 group-hover:translate-x-0.5 transition"
                                        ...
                                        <!-- Body -->
                                        <div
                                            class="p-3 max-h-[25rem] overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                                            <!-- Grid -->
                                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                                <!-- Link -->
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    href="../../pro/dashboard/index.html">
                                                    <img class="dark:hidden w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews/img1.jpg" alt="Main Page">
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img1.jpg" alt="Main Page">
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img21.jpg" alt="Main Page">
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img16.jpg" alt="Main Page">
                                                    ...
                                                    <div class="absolute -top-px end-[3px]">
                                                        <span
                                                            class="py-0.5 px-2 inline-flex items-center gap-x-1.5 text-xs font-medium bg-emerald-100 text-emerald-800 rounded-full dark:bg-emerald-900 dark:text-emerald-500">+4</span>
                                                    </div>
                                                </a>
                                                <!-- End Link -->
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="dark:hidden w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews/img26.jpg" alt="Main Page">
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img26.jpg" alt="Main Page">
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img8.jpg" alt="Main Page">
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img4.jpg" alt="Main Page">
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img14.jpg" alt="Main Page">
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img18.jpg" alt="Main Page">
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img9.jpg" alt="Main Page">
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img10.jpg" alt="Main Page">
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img11.jpg" alt="Main Page">
                                                ...
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  transition"
                                                    ...
                                                    <img class="hidden dark:block w-28 rounded-lg shadow"
                                                        src="../../assets/img/demo-previews-dark/img12.jpg" alt="Main Page">
                                        ...
                                        <div class="p-3 flex flex-wrap justify-center items-center gap-0.5">
                                            <div
                                                class="relative ps-2 ms-1 first:ps-0 first:ms-0 first:before:hidden before:hidden md:before:block before:absolute before:top-1/2 before:start-0 before:w-px before:h-4 before:bg-gray-200 before:-translate-y-1/2 dark:before:bg-neutral-700">
                                                <a class="group flex items-center gap-x-1.5 py-1.5 px-2 rounded-md text-[13px] text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                                                    href="../../pro/index.html">
                                                    Main page
                                    ...
                                    <div id="hs-pmn-free" class="" role="tabpanel" aria-labelledby="hs-pmn-item-free">
                                        ...
                                        <div
                                            ...
                                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                                ...
                                                <!-- Link -->
                                                <a class="p-3 relative flex flex-col justify-center items-center gap-y-3 rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 bg-gray-100 dark:bg-neutral-700 transition"
                ...
                <div class="relative flex flex-col h-full max-h-full">
                    <div class="px-6 pt-4 flex items-center">
                        ...
                        <div class="hidden lg:block ms-2">
                            <!-- Templates Dropdown -->
                            <div class="hs-dropdown  relative  [--auto-close:inside] inline-flex">
                                <button id="hs-dropdown-preview-sidebar" type="button"
                                    class="hs-dropdown-toggle  group relative flex justify-center items-center size-8 text-xs rounded-lg text-gray-800 hover:bg-gray-100 focus:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 disabled:opacity-50 disabled:pointer-events-none focus:outline-none"
                                    aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                    <span class="">
                                        <svg class=" size-4 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                <!-- Dropdown -->
                                <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-full md:w-[450px] transition-[opacity,margin] duration opacity-0 hidden z-30 overflow-hidden border border-gray-200 bg-white rounded-xl shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:bg-neutral-800 dark:border-neutral-700"
                                    role="menu" aria-orientation="vertical" aria-labelledby="hs-dropdown-preview-sidebar">
                                    <!-- Tab -->
                                    <div
                                        class="p-3 pb-0 flex flex-wrap justify-between items-center gap-3 border-b border-gray-200 dark:border-neutral-700">
                                        <!-- Nav Tab -->
                                        <nav class="flex  gap-x-1" aria-label="Tabs" role="tablist"
                                            ...
                                            <button type="button"
                                                class="hs-tab-active:after:bg-gray-800 hs-tab-active:text-gray-800 px-2 py-1.5 mb-2 relative inline-flex justify-center items-center gap-x-2 text-nowrap  hover:bg-gray-100 text-gray-500 hover:text-gray-800 text-sm rounded-lg disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-100 after:absolute after:-bottom-2 after:inset-x-2 after:z-10 after:h-0.5 after:pointer-events-none dark:hs-tab-active:text-neutral-200 dark:hs-tab-active:after:bg-neutral-400 dark:text-neutral-500 dark:hover:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  "
                                                id="hs-pms-item-pro" aria-selected="false" data-hs-tab="#hs-pms-pro"
                                                aria-controls="hs-pms-pro" role="tab">
                                                Pro
                                            </button>
                                            <button type="button"
                                                class="hs-tab-active:after:bg-gray-800 hs-tab-active:text-gray-800 px-2 py-1.5 mb-2 relative inline-flex justify-center items-center gap-x-2 text-nowrap  hover:bg-gray-100 text-gray-500 hover:text-gray-800 text-sm rounded-lg disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-100 after:absolute after:-bottom-2 after:inset-x-2 after:z-10 after:h-0.5 after:pointer-events-none dark:hs-tab-active:text-neutral-200 dark:hs-tab-active:after:bg-neutral-400 dark:text-neutral-500 dark:hover:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 active "
                                                id="hs-pms-item-free" aria-selected="true" data-hs-tab="#hs-pms-free"
                                                aria-controls="hs-pms-free" role="tab">
                                                Free
                                            </button>
                                        </nav>
                                        <!-- End Nav Tab -->
            ...
            <div
                ...
                <div class="flex items-center gap-px">
                    <div class="hs-tooltip inline-block">
                        <p
                            class="hs-tooltip-toggle inline-flex gap-x-2 text-xs text-white py-1 px-2 relative before:absolute before:top-1/2 before:-start-0.5 before:z-10 before:w-px before:h-4 before:bg-white/20 before:-translate-y-1/2 first:before:hidden">
                        ...
                        <span
                            class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 inline-block absolute invisible z-20 py-1.5 px-2.5 bg-neutral-900 text-xs text-white rounded-lg whitespace-nowrap dark:bg-neutral-800"
                            role="tooltip">
                    ...
                    <div
                        ...
                        <button id="hs-dropdown-preview" type="button"
                            ...
                            aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                            Templates
                            <svg class="hs-dropdown-open:rotate-180 shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="m18 15-6-6-6 6" />
                            </svg>
                        ...
                        <!-- Dropdown -->
                        <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-48 transition-[opacity,margin] duration opacity-0 hidden z-10 overflow-hidden border border-neutral-800 bg-neutral-900 rounded-lg shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:shadow-[0_10px_40px_10px_rgba(0,0,0,0.2)] dark:bg-neutral-800"
                            role="menu" aria-orientation="vertical" aria-labelledby="hs-dropdown-preview">
                            <div
                                class="max-h-[30rem] overflow-y-auto relative z-20 after:sticky after:inset-x-0 after:bottom-0 after:z-10 after:block after:w-full after:rounded-b-lg after:pointer-events-none after:bg-gradient-to-t after:from-neutral-900 after:via-neutral-900/95 dark:after:from-neutral-800 dark:after:via-neutral-800/95 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-neutral-800 [&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                                <div class="p-1 space-y-0.5">
                                    <span
                                        class="block p-2 pb-1 text-[11px] uppercase text-neutral-400 dark:text-neutral-400">Main
                                        Pages</span>
                                    ...
                                    <a class="group flex items-center gap-x-1.5 py-1.5 px-2 rounded-md text-[13px] text-gray-200 hover:bg-neutral-800 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700  "
                                        href="../../index.html">
                                        Preline UI
                                        <svg class="shrink-0 size-3.5 ms-auto opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round">
                                            <path d="M5 12h14" />
                                    ...
                                    <span
                                        class="block p-2 pb-1 text-[11px] uppercase text-neutral-400 dark:text-neutral-400">Template
                                        Previews</span>
