          ...
          before:inline-block before:size-6 before:bg-white checked:before:bg-white before:translate-x-0 checked:before:translate-x-full before:rounded-full before:shadow before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-neutral-400 dark:checked:before:bg-white"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span
                                class="mt-7 font-bold text-3xl md:text-4xl xl:text-5xl text-gray-800 dark:text-neutral-200">Free</span>
                            <p class="mt-2 text-sm text-gray-500 dark:text-neutral-500">Get started with basic features
                            </p>

                            <ul class="mt-7 space-y-2.5 text-sm">
                                <li class="flex gap-x-2">
                                    <svg class="shrink-0 mt-0.5 size-4 text-violet-900"
                    ...
                    <div class="flex justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24">
                        <svg class="size-16 md:size-20 lg:size-24 mx-auto sm:mx-0 text-gray-500 dark:text-neutral-500"
            ...
            <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
                ...
                <div class="hidden lg:block mt-6">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-1">
                            <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-violet-600 text-white hover:bg-violet-700 focus:outline-none focus:bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
                                href="#">
                                Get started
                            </a>
                        </div>
